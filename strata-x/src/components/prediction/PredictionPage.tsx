...
export const PredictionPage: React.FC = () => {
  const { riskAssessment, simulationState, startSafetySimulation, resetSimulation } = useApp();
    ...
    <div className="page-container">
      ...
      <div className="page-header">
        <div className="page-title-group">
          ...
          <p>
            Edge AI Multi-Sensor Correlation • NVIDIA Jetson Orin Nano Local Model • 24-Hour Predictive Strata Horizon
          </p>
        </div>

        <div className="header-actions">
          <span className="demo-tag">SIMULATED AI MODEL OUTPUT</span>
          <span className="demo-tag">JETSON TENSORRT ACCELERATED</span>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <strong>Prototype Transparency Notice:</strong> Model inference scores, confidence bands, and driver weights shown below are generated by the local edge neural network demo model. Values will continuously calibrate against physical borehole ground truth once connected to field instruments.
        </div>
      </div>
