        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          {stages.map((s, idx) => {
            ...
            return (
              <div
                key={s.stage}
                onClick={() => { playSoundEffect('drill-stage'); advanceSimulationStage(s.stage); }}
                style={{
                  padding: '8px 10px',
                  borderRadius: '4px',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: '8px', paddingTop: '6px' }}>
          ...
          <div style={{ display: 'flex', gap: '6px' }}>
            {simulationState.isActive ? (
              ...
              <button className="btn btn-sm btn-warning" onClick={() => { playSoundEffect('drill-stage'); startSafetySimulation(); }}>
                <Play size={13} />
